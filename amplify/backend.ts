...
import { cdkStack as custom2 } from "./custom/custom2/resource";
...
new custom2(backend.createStack("custom2"), "custom2");
new customfinance(backend.createStack("customfinance"), "customfinance", backend.data, backend.auth, backend.storage);
